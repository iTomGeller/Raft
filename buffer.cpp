...
#define __init_big_block(p, s)  __init_block(p, s, uint32);\
...
#define __data_of_block(p) __is_big_block(p) ? (byte*)(((byte*)((uint32*)(p) + 2)) + __pos_of_big_block(p)) : \
                           (byte*)(((byte*)((ushort*)(p) + 2)) + __pos_of_small_block(p))
